...
UPDATE `creature_template` SET `ScriptName`='npc_azure_saboteur', AIName='' WHERE entry=31079;
...
UPDATE `creature_template` SET `FactionAlliance` = 16, `FactionHorde` = 16 WHERE `entry` = 29364;
UPDATE `creature_template` SET `FactionAlliance` = 16, `FactionHorde` = 16 WHERE `entry` = 31518;
UPDATE `creature_template` SET `AIName`='' WHERE `entry` IN (29395);

-- triggers
UPDATE `creature_template` SET ExtraFlags = ExtraFlags | 128  WHERE entry IN (30857,30883,29326,30896);
...
UPDATE `creature_template` SET MechanicImmuneMask = MechanicImmuneMask |1|16|64|256|512|1024|2048|4096|8192|65536|131072|524288|8388608|536870912
