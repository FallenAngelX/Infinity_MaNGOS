DELETE FROM script_texts WHERE entry BETWEEN -1578043 AND -1578031;
INSERT INTO script_texts (entry,content_default, content_loc8, sound, type, language, emote, comment) VALUES
-- Drakos the Interrogator
(-1578031,'The prisoners shall not go free. The word of Malygos is law!','Узники не вырвутся на волю. Слово Малигоса - закон!',13594,1,0,0,'SAY_AGGRO'),
(-1578032,'A fitting punishment!','Заслуженное наказание!',13602,1,0,0,'SAY_KILL_1'),
(-1578033,'Sentence: executed!','Приговор приведен в исполнение!',13603,1,0,0,'SAY_KILL_2'),
(-1578034,'Another casualty of war!','Еще одна жертва войны!',13604,1,0,0,'SAY_KILL_3'),
(-1578035,'The war... goes on.','Война... продолжается.',13605,1,0,0,'SAY_DEATH'),
(-1578036,'It is too late to run!','Поздно убегать!',13598,1,0,0,'SAY_PULL_1'),
(-1578037,'Gather \'round!','Станьте в круг!',13599,1,0,0,'SAY_PULL_2'),
(-1578038,'None shall escape!','Не кто не уйдет живым!',13600,1,0,0,'SAY_PULL_3'),
(-1578039,'I condemn you to death!','Я приговариваю вас к смерти!',13601,1,0,0,'SAY_PULL_4'),
(-1578040,'Tremble, worms!','Трепещите, черви!',13595,1,0,0,'SAY_STOMP_1'),
(-1578041,'I will crush you!','Я раздавлю вас!',13596,1,0,0,'SAY_STOMP_2'),
(-1578042,'Can you fly?','Вы умеете летать?',13597,1,0,0,'SAY_STOMP_3'),
(-1578043,'Intruders, your victory will be short-lived. I am Commander Varos Cloudstrider. My drakes control the skies and protest this conduit. I will see to it personally that the Oculus does not fall into your hands!','Чужаки, ваш триумф будет не долгим. Я командир Варос Заоблачный странник. Мои драконы обозревают небеса и защищают это место. Я позабочусь, чтобы Окулус не достался вам!',13648,1,0,0,'SAY_VAROS_SPAWN');

-- The following script_text are not removed to keep ruRU locales. If someone is interested in, convert the following to updates for base_scriptdev2_full.sql. From -1578000 to ...
