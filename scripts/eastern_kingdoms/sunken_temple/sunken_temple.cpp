...
bool AreaTrigger_at_shade_of_eranikus(Player* pPlayer, AreaTriggerEntry const* /*pAt*/)
{
    if (ScriptedInstance* pInstance = (ScriptedInstance*)pPlayer->GetInstanceData())
    {
                ...
                pPlayer->GetQuestStatus(QUEST_ERANIKUS_TYRANT_OF_DREAMS) != QUEST_STATUS_COMPLETE)
        {
            ...
            {
                pPlayer->SummonCreature(NPC_MALFURION, aSunkenTempleLocation[2].x, aSunkenTempleLocation[2].y, aSunkenTempleLocation[2].z, aSunkenTempleLocation[2].o, TEMPSUMMON_DEAD_DESPAWN, 0);
