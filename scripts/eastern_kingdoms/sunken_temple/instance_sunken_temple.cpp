    ...
    switch (uiType)
    {
        ...
        case TYPE_AVATAR:
            ...
            if (uiData == IN_PROGRESS)
            {
                ...
                if (Creature* pShade = pPlayer->SummonCreature(NPC_SHADE_OF_HAKKAR, aSunkenTempleLocation[1].x, aSunkenTempleLocation[1].y, aSunkenTempleLocation[1].z, aSunkenTempleLocation[1].o, TEMPSUMMON_MANUAL_DESPAWN, 0))
                {
...
void instance_sunken_temple::DoSpawnAtalarionIfCan()
{
    ...
    pPlayer->SummonCreature(NPC_ATALARION, aSunkenTempleLocation[0].x, aSunkenTempleLocation[0].y, aSunkenTempleLocation[0].z, aSunkenTempleLocation[0].o, TEMPSUMMON_DEAD_DESPAWN, 0);
...
void instance_sunken_temple::Update(uint32 uiDiff)
{
    ...
    if (m_uiSupressorTimer)
    {
        if (m_uiSupressorTimer <= uiDiff)
        {
            ...
            pShade->SummonCreature(NPC_SUPPRESSOR, aHakkariDoorLocations[uiSummonLoc].x, aHakkariDoorLocations[uiSummonLoc].y, aHakkariDoorLocations[uiSummonLoc].z, 0, TEMPSUMMON_DEAD_DESPAWN, 0);
