...
void AddSC_custom_gameobjects()
{
    ...
    pNewScript->Name             = "custom_gameobject_deception_orb";
    pNewScript->pGOUse         = &GOUse_custom_gameobject_deception_orb;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_gameobject_morph";
    pNewScript->pGOUse         = &GOUse_custom_gameobject_morph;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_gameobject_spellmachine";
    pNewScript->pGOUse         = &GOUse_custom_gameobject_spellmachine;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_gameobject_chestbank";
    pNewScript->pGOUse         = &GOUse_custom_gameobject_chestbank;
    pNewScript->RegisterSelf(false);
}