...
bool GossipHello_custom_npc_buffmaster(Player* pPlayer, Creature* pCreature)
{
	...
	bool SmallBuffsEnabled = IMaNGOSConfig.GetBoolDefault("BuffsMaster.SmallBuffsEnabled", true);
	bool GreatBuffsEnabled = IMaNGOSConfig.GetBoolDefault("BuffsMaster.GreatBuffsEnabled", true);
	bool GameMasterBuffsEnabled = IMaNGOSConfig.GetBoolDefault("BuffsMaster.GameMasterBuffsEnabled", true);
	bool PlayerToolsEnabled = IMaNGOSConfig.GetBoolDefault("BuffsMaster.PlayerToolsEnabled", true);
	bool GoldSpellEnabled = IMaNGOSConfig.GetBoolDefault("BuffsMaster.GoldSpellEnabled", false);
...
void SendDefaultMenu_custom_npc_buffmaster(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    ...
    //Money Check
    if (pPlayer->GetMoney() < (IMaNGOSConfig.GetFloatDefault("BuffsMaster.BuffCost",0)))
    {
        pPlayer->CLOSE_GOSSIP_MENU();
    ...
    switch(uiAction)
    {
        ...
        case 1001: // Buff me Mark of the Wild
        {
            ...
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("BuffsMaster.BuffCost",0)));
            break;
        }
...
bool getGuildHouseCoords(uint32 guildId, float &x, float &y, float &z, uint32 &map)
{
    ...
    QueryResult *result;
    result = WorldDatabase.PQuery("SELECT `x`, `y`, `z`, `map` FROM `guildhalls` WHERE `guildId` = %u", guildId);
    if(result)
    {
...
void teleportPlayerToGuildHouse(Player* pPlayer, Creature *_creature)
{
    ...
    {
        //if player in combat
        _creature->MonsterSay(MSG_INCOMBAT, LANG_UNIVERSAL, pPlayer);
        return;
    }
    ...
    {
        //if player has no guild
        _creature->MonsterWhisper(MSG_NOTINGUILD, pPlayer, false);
        return;
    }
    ...
    if (getGuildHouseCoords(pPlayer->GetGuildId(), x, y, z, map))
    {
        ...
        _creature->MonsterWhisper(MSG_NOGUILDHOUSE, pPlayer, false);
...
bool showBuyList(Player *player, Creature *_creature, uint32 showFromId = 0)
{
    ...
    QueryResult *result;
    result = WorldDatabase.PQuery("SELECT `id`, `comment` FROM `guildhalls` WHERE `guildId` = 0 AND `id` > %u ORDER BY `id` ASC LIMIT %u", showFromId, GOSSIP_COUNT_MAX);
...
bool isPlayerHasGuildhouse(Player *player, Creature *_creature, bool whisper = false)
{
    ...
    result = WorldDatabase.PQuery("SELECT `comment` FROM `guildhalls` WHERE `guildId` = %u", player->GetGuildId());
...
void buyGuildhouse(Player *player, Creature *_creature, uint32 guildhouseId)
{
    ...
    result = WorldDatabase.PQuery("SELECT `id` FROM `guildhalls` WHERE `id` = %u AND `guildId` <> 0", guildhouseId);
    ...
    //update DB
    result = WorldDatabase.PQuery("UPDATE `guildhalls` SET `guildId` = %u WHERE `id` = %u", player->GetGuildId(), guildhouseId);
...
void sellGuildhouse(Player *player, Creature *_creature)
{
    if (isPlayerHasGuildhouse(player, _creature))
    {
        ...
        result = WorldDatabase.PQuery("UPDATE `guildhalls` SET `guildId` = 0 WHERE `guildId` = %u", player->GetGuildId());
...
bool GossipHello_custom_npc_professionmaster(Player* pPlayer, Creature* pCreature)
{
    ...
    bool ProfessionsEnabled = IMaNGOSConfig.GetBoolDefault("ProfessionMaster.ProfessionsEnabled", true);
    bool SecondarySkillsEnabled = IMaNGOSConfig.GetBoolDefault("ProfessionMaster.SecondarySkillsEnabled", true);
...
void SendDefaultMenu_custom_npc_professionmaster(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    ...
    //Money Check
    if (pPlayer->GetMoney() < (IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)))
    {
        pPlayer->CLOSE_GOSSIP_MENU();
        pCreature->MonsterWhisper("You don't have enough money.", pPlayer, false);
        return;
    ...
    switch(uiAction)
    {
        ...
        case 1001: // Alchemy
            ...
            {
            pPlayer->UpdateSkill(171,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1002: // Blacksmithing
            ...
            {
            pPlayer->UpdateSkill(164,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1003: // Enchanting
            ...
            {
            pPlayer->UpdateSkill(333,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1004: // Engineering
            ...
            {
            pPlayer->UpdateSkill(202,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1005: // Herbalism
            ...
            {
            pPlayer->UpdateSkill(182,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1006: // Inscription
            ...
            {
            pPlayer->UpdateSkill(773,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1007: // Jewelcrafting
            ...
            {
            pPlayer->UpdateSkill(755,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1008: // Leatherworking
            ...
            {
            pPlayer->UpdateSkill(165,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1009: // Mining
            ...
            {
            pPlayer->UpdateSkill(186,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1010: // Skinning
            ...
            {
            pPlayer->UpdateSkill(393,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1011: // Tailoring
            ...
            {
            pPlayer->UpdateSkill(197,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 2001: // Cooking
            ...
            {
            pPlayer->UpdateSkill(185,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 2002: // First Aid
            ...
            {
            pPlayer->UpdateSkill(129,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 2003: // Fishing
            ...
            {
            pPlayer->UpdateSkill(356,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 2005: // Archaeology
            ...
            {
            pPlayer->UpdateSkill(794,(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(IMaNGOSConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
...
bool GossipSelect_custom_npc_resetlevel(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
    ...
    if (uiAction == GOSSIP_ACTION_INFO_DEF+1)
    {
        if (pPlayer->getLevel() == (IMaNGOSConfig.GetFloatDefault("ResetMaster.ResetMinimumLevel",0)))
        {
			Config IMaNGOSConfig;
			if (!IMaNGOSConfig.SetSource(_MANGOSD_CONFIG))
				error_log("IMaNGOS: Unable to open configuration file");
            ...
            pPlayer->CLOSE_GOSSIP_MENU();
            pPlayer->ModifyMoney(+(IMaNGOSConfig.GetFloatDefault("ResetMaster.ResetAddMoney",0)));
            pPlayer->SetLevel((IMaNGOSConfig.GetFloatDefault("ResetMaster.LevelAfterReset",0)));
        }
        else
        {
...
bool GossipHello_custom_npc_spellmaster(Player* pPlayer, Creature* pCreature)
{
	...
	bool LearnAllWeapons = IMaNGOSConfig.GetBoolDefault("Spellmaster.LearnAllWeapons", true);
	bool LearnAllLanguages = IMaNGOSConfig.GetBoolDefault("Spellmaster.LearnAllLanguages", true);
	bool MaxOutWeaponSkills = IMaNGOSConfig.GetBoolDefault("Spellmaster.MaxOutWeaponSkills", true);
	bool MaxOutRidingSkills = IMaNGOSConfig.GetBoolDefault("Spellmaster.MaxOutRidingSkills", true);
	bool MaxOutLanguageSkills = IMaNGOSConfig.GetBoolDefault("Spellmaster.MaxOutAllLanguageSkills", true);

	if (pPlayer->getLevel() > (IMaNGOSConfig.GetFloatDefault("SpellMaster.MinimumLevel", 0)))
    {
        // Warrior Spells
...
{
    QueryResult* pResult = WorldDatabase.PQuery("SELECT ID,Cost,MapID,Xpos,Ypos,Zpos,Rpos,Name FROM teleportmaster_locations ORDER BY id");
    if(pResult)
    {
        do
        {
...
void ProcessMenu_custom_npc_teleportmaster(Player *player, Creature *Creature, uint32 action, uint32 MoreLess, uint32 GroupID)
{
    ...
    if( action<=1000 )
    {
        pResult = WorldDatabase.PQuery("SELECT CategoryID,CategoryName,SubCatGroupID,SubCatName FROM teleportmaster_categories WHERE CategoryID >= \"%i\" AND CategoryID <= \"%i\" ORDER BY CategoryID", action, throttle);
        //Not a SubCat, list out locations
        if( pResult->Fetch()[2].GetInt32()==0 && (action>100 || (action<=100 && action>0 && MoreLess==0)) )
        {
            pResult = WorldDatabase.PQuery("SELECT ID,CategoryID,Name,faction,ReqLevel,GuildID,Cost FROM teleportmaster_locations WHERE CategoryID = \"%i\" ORDER BY ID", action);
            locations = 1;
        }
        else if(action<=1000 && action>1)
        {
            if(MoreLess>0 || action<=100)
            {
                ...
                {
                    QueryResult* pResultGroup = WorldDatabase.PQuery("SELECT CategoryID,CategoryName,SubCatGroupID,SubCatName FROM teleportmaster_categories WHERE CategoryID = \"%i\"", action);
                    if(pResultGroup)
                    {
                        GroupID = pResultGroup->Fetch()[2].GetInt32();
                        pResult = WorldDatabase.PQuery("SELECT CategoryID,CategoryName,SubCatGroupID,SubCatName FROM teleportmaster_categories WHERE CategoryID >= \"%i\" AND SubCatGroupID = \"%i\" ORDER BY CategoryID", action, GroupID);
                    }
                }
            }
            else
    ...
    if(action>1000)
    {
        if(MoreLess>0)
        {
            QueryResult* pResultGroup = WorldDatabase.PQuery("SELECT ID,CategoryID FROM teleportmaster_locations WHERE ID = \"%i\"", action);
            if(pResultGroup)
            {
                GroupID = pResultGroup->Fetch()[1].GetInt32();
				pResult = WorldDatabase.PQuery("SELECT ID,CategoryID,Name,faction,ReqLevel,GuildID,Cost FROM teleportmaster_locations WHERE CategoryID = \"%i\" AND ID>= \"%i\" ORDER BY ID", GroupID, action);
                locations = 1;
            }
        }
        else
    ...
    {
        pResult = WorldDatabase.PQuery("SELECT ID,CategoryID,faction,ReqLevel,GuildID,Name,cost FROM teleportmaster_locations WHERE CategoryID = \"%i\" ORDER BY ID",action);
        if(pResult)
        {
            if(DEBUG_TELE)
    ...
    if(MoreLess>0 || locations)
    {
        ...
        else
        {
            ...
            if(action>=1000)
				pResultPrev = WorldDatabase.PQuery("SELECT ID,CategoryID,faction,ReqLevel,GuildID FROM teleportmaster_locations WHERE CategoryID = \"%i\" AND ID <= \"%i\" ORDER BY ID DESC", GroupID, action);
            if(action>=100 && action<1000)
                pResultPrev = WorldDatabase.PQuery("SELECT CategoryID,SubCatGroupID FROM teleportmaster_categories WHERE SubCatGroupID = \"%i\" AND CategoryID <= \"%i\" ORDER BY CategoryID DESC",GroupID,action);
            if(action>1 && action<100)
                pResultPrev = WorldDatabase.PQuery("SELECT CategoryID,SubCatGroupID FROM teleportmaster_categories WHERE CategoryID <= \"%i\" ORDER BY CategoryID DESC",action);
...
bool GossipHello_custom_npc_teleportmaster(Player* pPlayer, Creature* Creature)
{
...
void SendDefaultMenu_custom_npc_teleportmaster(Player *player, Creature *Creature, uint32 action)
{
    ...
    int32 Group = 0;
    QueryResult* pResult = WorldDatabase.PQuery("SELECT CategoryID,SubCatGroupID FROM teleportmaster_categories ORDER BY CategoryID");
    // Make sure the result is valid
    if(pResult)
    {
        do
...
bool GossipHello_custom_npc_tokenvendor(Player* pPlayer, Creature* pCreature)
{
    ...
    if(pPlayer->getLevel() < (IMaNGOSConfig.GetFloatDefault("TokenVendor.MaxLevel",0)))
...
void SendDefaultMenu_custom_npc_tokenvendor(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    ...
    uint32 itemId2 = 23162; // 36 bag slot, I suppose ?
...
struct custom_script_training_dummy : public Scripted_NoMovementAI
{
    uint32 combat_timer;

    custom_script_training_dummy(Creature* pCreature) : Scripted_NoMovementAI(pCreature)
    {
        Reset();
    }
...
{
    return new custom_script_training_dummy(pCreature);
}

// custom_npc_arena_honor

bool GossipHello_custom_npc_arena_honor(Player* pPlayer, Creature *pCreature)
{
...
bool GossipSelect_custom_npc_arena_honor(Player *pPlayer, Creature *pCreature, uint32 sender, uint32 action)
{
...
void AddSC_custom_npcs()
{
    ...
    pNewScript->Name             = "custom_npc_buffmaster";
    pNewScript->pGossipHello     = &GossipHello_custom_npc_buffmaster;
    pNewScript->pGossipSelect    = &GossipSelect_custom_npc_buffmaster;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_npc_guildmaster";
    pNewScript->pGossipHello     = &GossipHello_custom_npc_guildmaster;
    pNewScript->pGossipSelect    = &GossipSelect_custom_npc_guildmaster;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_npc_news";
    pNewScript->pGossipHello     = &GossipHello_custom_npc_news;
    pNewScript->pGossipSelect    = &GossipSelect_custom_npc_news;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_npc_professionmaster";
    pNewScript->pGossipHello     = &GossipHello_custom_npc_professionmaster;
    pNewScript->pGossipSelect    = &GossipSelect_custom_npc_professionmaster;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_npc_renamecharacter";
    pNewScript->pGossipHello     = &GossipHello_custom_npc_renamecharacter;
    pNewScript->pGossipSelect    = &GossipSelect_custom_npc_renamecharacter;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_npc_resetinstance";
    pNewScript->pGossipHello     = &GossipHello_custom_npc_resetinstance;
    pNewScript->pGossipSelect    = &GossipSelect_custom_npc_resetinstance;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_npc_resetlevel";
    pNewScript->pGossipHello     = &GossipHello_custom_npc_resetlevel;
    pNewScript->pGossipSelect    = &GossipSelect_custom_npc_resetlevel;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_npc_spellmaster";
    pNewScript->pGossipHello     = &GossipHello_custom_npc_spellmaster;
    pNewScript->pGossipSelect    = &GossipSelect_custom_npc_spellmaster;
    pNewScript->RegisterSelf(false);

    pNewScript                  = new Script;
    pNewScript->Name            = "custom_npc_teleportmaster";
    pNewScript->pGossipHello    = &GossipHello_custom_npc_teleportmaster;
    pNewScript->pGossipSelect   = &GossipSelect_custom_npc_teleportmaster;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_npc_titlemaster";
    pNewScript->pGossipHello     = &GossipHello_custom_npc_titlemaster;
    pNewScript->pGossipSelect    = &GossipSelect_custom_npc_titlemaster;
    pNewScript->RegisterSelf(false);

    pNewScript                   = new Script;
    pNewScript->Name             = "custom_npc_tokenvendor";
    pNewScript->pGossipHello     = &GossipHello_custom_npc_tokenvendor;
    pNewScript->pGossipSelect    = &GossipSelect_custom_npc_tokenvendor;
    pNewScript->RegisterSelf(false);

    pNewScript = new Script;
    pNewScript->Name = "custom_script_training_dummy";
    pNewScript->GetAI = &GetAI_custom_script_training_dummy;
    pNewScript->RegisterSelf(false);

    pNewScript = new Script;
    pNewScript->Name="custom_npc_arena_honor";
    pNewScript->pGossipHello =  &GossipHello_custom_npc_arena_honor;
    pNewScript->pGossipSelect = &GossipSelect_custom_npc_arena_honor;
    pNewScript->RegisterSelf(false);
}